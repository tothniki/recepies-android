...
public class TestHelper {
    public static void setTestInjector() {
        ...
        RecepiesApplicationComponent injector = DaggerTestComponent.builder().uIModule(new UIModule(app.getApplicationContext())).mockDBModule(new MockDBModule(app)).build();
